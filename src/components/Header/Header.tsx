...
import {FaSearch, FaHome, FaBell, FaSuitcase, FaComments, FaUsers} from 'react-icons/fa'
					...
					<div className="relative inline-block">
						...
						<Link to="/profile">
							<div className="cursor-pointer mr-2">
								<HeaderOption
									NoMarginRight
									avatar={user?.photoURL ?? 'https://img.freepik.com/premium-vector/businessman-avatar-cartoon-character-profile_18591-50581.jpg'}
									title="Profile"
								/>
							</div>
						</Link>
