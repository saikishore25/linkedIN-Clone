...
import { LoginSchemaValidation } from '../utils/validators/auth'
...
const LogInScreen = ()=> {
	...
	const {register, handleSubmit, formState: { errors }} = useForm<AuthLoginRequestType>({

		resolver: yupResolver(LoginSchemaValidation)
	})

	const registerUserWithEmailAndPasswordHandler: SubmitHandler<AuthLoginRequestType> = async (data) => {
